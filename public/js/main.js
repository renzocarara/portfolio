...
__webpack_require__(/*! ../../node_modules/bootstrap/dist/js/bootstrap.bundle.min.js */ "./node_modules/bootstrap/dist/js/bootstrap.bundle.min.js"); // abilito Boostrap tooltip
...
$(document).ready(function () {
  ...
  closeHamburgerMenu(); // gestisco lo sfondo della navbar al click sull'icona hamburger

  handleClickOnHamburgerMenu(); // smooth scoll per i link interni alla pagina

  internalLinkSmoothScroll(); // gestisco la visualizzazione del bottone BackToTop (BTT)

  handleBTTButton(); // visualizzo lo spinner quando l'utente preme "Invia"
